...
abstract class AntlrAutoCompleter<T : Parser> : AutoCompleter {
    ...
    protected abstract fun processSuggestions(
        antlrCompletionData: AntlrCompletionData, parseTree: ParseTree,
        completionFactory: (text: String, type: String) -> Completion
    ): Set<Completion>

    override fun suggestCompletion(
        text: String,
        startOfCompletionCaretPosition: Int,
        currentCaretPosition: Int,
        astBasedAction: ((result: MutableSet<Completion>, ast: ASTNode) -> Unit)?
    ): List<Completion> {
        ...
        val startContext = runStartRule(parser)
        ...
        val curry = { completionText: String, type: String ->
            Completion(
                completionText,
                text,
                startOfReplace,
        ...
        val result = processSuggestions(suggestCompletions, startContext, curry)
